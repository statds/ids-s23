...
figure,(fig, fig1) = plt.subplots(1, 2, figsize = (8, 6))

fig.scatter(y, z, marker = '^')
fig1.scatter(x, y, color = 'red')
...
fig.plot(x, z, label = "Line Graph")
fig1.scatter(x, y, z, c = z, cmap = 'cool', label = "Scatter in 3D")
fig.legend()
fig1.legend()
