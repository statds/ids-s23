...
```
```{python}
# Showing manually created PNG file of the map in this output
from IPython.display import Image
Image(filename="map1greyed.png", width=300, height=300)
```
...
```{python}
#| echo: false
# Displaying the image of map2 in this notebook
Image(filename="map2.png", width=300, height=300)
```
...
```{python}
#| echo: false
# Displaying the map3 image example in this notebook
Image(filename="map3.png", width=300, height=300)
```
...
```{python}
#| echo: false
# Displaying the map4 image example in this notebook
Image(filename="map4.png", width=300, height=300)
```
...
```{python}
#| echo: false
# Displaying the map5 image example in this notebook
#Image(filename="map5.png", width=300, height=300)
```